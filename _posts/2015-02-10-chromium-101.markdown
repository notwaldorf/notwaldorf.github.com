...
<a href="https://code.google.com/p/chromium/codesearch#search/&q=IDS_PROFILES_SWITCH_USERS_BUTTON&sq=package:chromium&type=cs"><img width="656" src="/images/chromium/codesearch_1.png" alt="The files that are relevant and appear in the search are 'profile_chooser_view.cc' and 'profile_chooser_controller.mm'"></a>
