...
If you want a TL;DR or a refresher of the commands you might needs, check out the [slides] (https://speakerdeck.com/notwaldorf/contributing-to-chromium). 
**Warning**: this is a long post. The bug we're fixing is silly, but will get
us writing actual Chromium code. 
- 
- If you want a
